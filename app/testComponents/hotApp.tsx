...
import { Frame, Page, StackLayout, ProxyViewContainer, ContentView, View, TabView, Label } from "react-nativescript/dist/client/ElementRegistry";
...
import { $ContentView, $StackLayout, $Label, $FlexboxLayout, $Button, $Frame, $Page } from 'react-nativescript';
...
const app = () =>  <MyComponent forwardedRef={rootRef}/>
